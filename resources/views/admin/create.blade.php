...
<div class="col-md-4 mb-3" id="div1" hidden>
    <div id="ibu" hidden>
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="rs_hp" id="rs_hp" aria-describedby="" placeholder="">
                </div>
...
<div class="col-md-4" id="div2" hidden>
